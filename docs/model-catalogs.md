...
- `model_under_test`: the engine being fingerprinted
- `assistant`: an optional helper used later for operator-side review, comparison, or commentary
...
3. Run the harness against that endpoint.
...
1. Complete a normal harness run.
